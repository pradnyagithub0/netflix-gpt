  ...
  return (
      <div className='pt-[18%] px-20 absolute text-white bg-gradient-to-r from-black w-screen aspect-video'>
          ...
          <div>
              ...
              <button className='bg-gray-500 text-white px-7 py-2 bg-opacity-50 rounded-lg text-lg mr-3 hover:bg-opacity-80'><i className="bi bi-info-circle"></i> More Info</button>
          </div>
    </div>
  )
}
